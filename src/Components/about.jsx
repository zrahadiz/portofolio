    ...
    return (
      <div id="about" className="scroll-mt-20">
        ...
        <div className="mt-10 font-quicksand text-white text-center">
          ...
          <h2 className="mt-5 mx-5 sm:mx-20 lg:mx-60 text-sm xs:text-lg break-words">
            {description}
          </h2>
        </div>
        <div className="mt-5 font-quicksand font-semibold text-slate-200 text-center">
          ...
          <ul className="flex justify-center items-center mt-2 space-x-2">
            ...
            <li className="hover:shadow-2xl hover:shadow-[#4078c0]">
              <a
                href="https://www.instagram.com/zrahadiz/"
                target="_blank"
                rel="noreferrer"
              >
                <Icon icon="skill-icons:instagram" width={36} />
              </a>
            </li>
            <li className="hover:shadow-2xl hover:shadow-[#25d366]">
              <a
                href="https://wa.me/628111107244"
                target="_blank"
                rel="noreferrer"
              >
                <Icon
            ...
            <li className="hover:shadow-2xl hover:shadow-[#4078c0]">
              <a
                ...
                rel="noreferrer"
              >
                <Icon icon="skill-icons:linkedin" width="36" />
              </a>
            </li>
          </ul>
          <div className="mt-2">
            <a
              ...
              rel="noreferrer"
            >
              <button className="bg-[#4078c0] p-2 rounded-lg hover:bg-[#294161]">
                Download CV
              </button>
            </a>
          </div>
